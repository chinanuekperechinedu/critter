...
public class CritterFunctionalTest {
    ...
    static void initTest() throws SQLException{
        Server.createWebServer("-web", "-webAllowOthers", "-webPort", "8085", "-webDaemon").start();
    }
    ...
    public void testSchedulePetsForServiceWithEmployee() {
        ...
        ScheduleDTO sched = scheduleController.createSchedule(createScheduleDTO(petList, employeeList, date, skillSet));
